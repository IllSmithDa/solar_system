...
`)+`
`+g);const L=I+y+c,C=I+g+d,V=Pm(a,a.VERTEX_SHADER,L),N=Pm(a,a.FRAGMENT_SHADER,C);a.attachShader(A,V),a.attachShader(A,N),n.index0AttributeName!==void 0?a.bindAttribLocation(A,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(A,0,"position"),a.linkProgram(A);function F(z){if(s.debug.checkShaderErrors){const se=a.getProgramInfoLog(A).trim(),te=a.getShaderInfoLog(V).trim(),ce=a.getShaderInfoLog(N).trim();let he=!0,oe=!0;if(a.getProgramParameter(A,a.LINK_STATUS)===!1)if(he=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(a,A,V,N);else{const le=Dm(a,V,"vertex"),B=Dm(a,N,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(A,a.VALIDATE_STATUS)+`
